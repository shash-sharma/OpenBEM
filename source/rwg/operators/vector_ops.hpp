...
#ifndef BEM_RWG_OPS_VECTOR_OPS_H
#define BEM_RWG_OPS_VECTOR_OPS_H
...
public:
    ...
    /**
    * @brief Constructs a `VectorRwgOps` object with a specified integration object.
    ...
    */
    std::unique_ptr<OperatorBase<3, 12>> clone() const override
    { return std::make_unique<VectorRwgOps<ObsIntegratorType>> (*this); };
