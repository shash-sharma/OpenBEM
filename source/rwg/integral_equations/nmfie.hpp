...
/**
* @file
* Class for assembling discrete operators for the NMFIE.
*/

#ifndef BEM_RWG_INTEQ_NMFIE_H
#define BEM_RWG_INTEQ_NMFIE_H
...
/**
* @brief Class defining the RWG-based NMFIE.
...
class Nmfie: public IntegralEquationBase<MatrixType>
{
...
public:
    ...
    /**
    * @brief Sets custom operators for the `Nmfie` object.
    ...
    */
    ...
    /**
    * @brief Computes the operator matrix associated with the electric surface current density.
    ...
    */
    ...
    /**
    * @brief Computes the operator matrix associated with the magnetic surface current density.
    * @param[in] f - Frequency in Hz.
    * @param[in] material - Material for which the equation is defined.
    * @return Operator matrix.
    */
    ...
    */
        ...
        )
    {
        ...
        ExcitationAssembler<NxRwg> exc_assembler (base::obs_mesh_, obs_elems);
