...
void test_efie_pec()
{
    ...
    {
        std::cout << "====== test_efie_pec ======" << std::endl;
...
void test_nmfie_pec()
{
    ...
    json sphere_ref = json::parse(in_stream_ref);
    ...
    std::ofstream out_stream (path + "/dump/sphere_nmfie_pec.json");
    out_stream << std::setw(4) << out << std::endl;
    ...
    if (rcs_err > 10e-2 || escat_err > 5e-2)
    {
        std::cout << "====== test_nmfie_pec ======" << std::endl;
        std::cout << "Fail:" << std::endl;
        std::cout << "--- RCS error " << rcs_err * 100 << " %" << std::endl;
        std::cout << "--- Escat_mag error " << escat_err * 100 << " %" << std::endl;
    }
